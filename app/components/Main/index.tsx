...
const Main = () => {
  return (
    ...
    <section id="landing" className="section">
        ...
        <img aria-hidden="true" className="swoop light-swoop" src="https://d33wubrfki0l68.cloudfront.net/25e94eabb1cdec2613bd265d645dc15324bacfe8/86f45/images/landing-swoosh.svg" alt="" />
        <img aria-hidden="true" className="swoop dark-swoop " src="https://d33wubrfki0l68.cloudfront.net/2c499269a4a33fbbfca28010db8fdbb668a23c1c/beba6/images/landing-swoosh-dark.svg" alt="" />
    </section>



    <section id="what-we-do" className="section">
        <div className="what-topper">
            <div className="what-we-do-topper container">
                <h2>
                    <span>WHAT </span> WE DO
                </h2>
                <div aria-hidden="true" className="graphic-group">
                    <div className="dash"></div>
                    <img src="https://d33wubrfki0l68.cloudfront.net/29048d9efe89252399122cd2487f253dcbe9bcc4/cf8a5/images/code.svg" alt="" />
                    <div className="dash"></div>
                </div>
                <p>We specialize in small business web design and development for clients anywhere in the US. Every line of code is written by hand to ensure the best performance, which helps bring in more customers to your site and bring more revenue to your business.
                </p>
            </div>
        </div>
    ...
    <section id="pricing" className="section">
        <div className="container">
            <img className="piggy-bank" src="https://d33wubrfki0l68.cloudfront.net/1a6a7635d723bd43ad01eb8e14ca555ade9200d9/e643b/images/savings.svg" alt="drawing of a man next to a large piggy bank" width="300px" />
            <div className="left">
