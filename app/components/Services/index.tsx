...
const Services = () => {
  return (
    ...
    <section id="web-dev" className="section template">
        <div className="container">
            <img src="https://d33wubrfki0l68.cloudfront.net/056812f1d18390665bc20f315b66c795066e513f/68074/images/code-scg.svg" alt="man staring at an open browser window" />
            <div className="section-content">
                <h2>Web Design & Development Done Differently</h2>
                <p>What makes us unique in the development world is that we don't use WordPress, frameworks, or page builders.  
                We meticulously write the code line by line.  This gives us much more control over the design, 
                and the website performs lightning fast because there's no bloated or messy code that slows it down.
                <br/><br/>
                Websites built by hand will <span>out-perform most WordPress sites</span> and drag and drop page builders 
                which could cost thousands of dollars.  When it comes to the web, the faster and more organized websites win.
                </p>
              
            </div>
        </div>
        <div aria-hidden="true" className="paper-airplane-path container">
            <div className="line-box">
                <div className="svg-div">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 58.064 58.064"  xml:space="preserve" width="512px" height="512px" className=""><g><polygon style={{fill:'#43B7FF'}} points="17.064,31.032 58.064,10.032 24.064,35.032 44.064,48.032 58.064,10.032 0,22.032 " data-original="#7383BF" className="" data-old_color="#7383BF"/><polygon style={{fill:'#3D84D5'}} points="24.064,35.032 20.127,48.032 17.064,31.032 58.064,10.032 " data-original="#556080" className="" data-old_color="#556080"/><polygon style={{fill: '#3D84D5'}} points="24.064,35.032 20.064,48.032 31.912,40.133 " data-original="#464F66" className="active-path" data-old_color="#464F66"/></g> </svg>
                </div>
            </div>
        </div>
    </section>

    <section id="seo" className="section template">
        <div className="container">
            <img src="https://d33wubrfki0l68.cloudfront.net/82dfa31bd7245d1c5b7be8fd5b4ed281b6c32d63/183d7/images/speed.svg" alt="man standing in front of a computer"/>
            <div className="section-content">
                <h2>Search Engine Optimization For 2021</h2>
                <p>If someone tells you they can get you to the front page of Google in 3 months - <span>RUN!</span> Unless your website 
                   was featured by The New York Times it could take years to rank in the top of the search results.
                   <br/><br/>
                   We offer a number of the latest search engine optimization techniques for 2021:
                </p>
                <ul className="checkmark">
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt="" />Keyword-Centered Content & Blogs</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/>Mobile-First-Optimized for the Best Experience</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/>Clean & Organized Code Structure For Web Crawlers</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/>Fully Responsive For Mobile, Tablet, & Desktop</li>
                </ul>
        ...
        <div aria-hidden="true" className="paper-airplane-path container">
            <div className="line-box">
                <div className="svg-div">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 58.064 58.064"  width="512px" height="512px" className=""><g><polygon style={{fill: '#43B7FF'}} points="17.064,31.032 58.064,10.032 24.064,35.032 44.064,48.032 58.064,10.032 0,22.032 " data-original="#7383BF" className="" data-old_color="#7383BF"/><polygon style={{fill:'#3D84D5'}} points="24.064,35.032 20.127,48.032 17.064,31.032 58.064,10.032 " data-original="#556080" className="" data-old_color="#556080"/><polygon style={{fill:'#3D84D5'}} points="24.064,35.032 20.064,48.032 31.912,40.133 " data-original="#464F66" className="active-path" data-old_color="#464F66"/></g> </svg>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="graphic-design" className="section template">
        <div className="container">
            <img src="https://d33wubrfki0l68.cloudfront.net/a9cb42a527a8f7d16f3804d86dc12261c3f33f80/58d60/images/design-svg.svg" alt="man standing next graphic display"/>
            <div className="section-content">
                <h2>Logos, Graphic Design, & Branding</h2>
                <p>We also offer logo and graphic design services via our own in-house graphic designer.  If you have an 
                    existing logo that needs a touch up or need a completely new one we can help build your business's brand.
                </p>
                <ul>
                    <li>
                        <h3><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> Logos Starting at $350</h3>
                        <p>Rates may increase based on complexity, number of hours, and number of revisions</p>
                    </li>
                    <li>
                        <h3><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/>Social Media Graphics</h3>
    ...
    <section id="updates" className="section template">
        <div className="container">
        <div className="section-content">
    ...
    <section id="pricing" className="section ">
        <div className="container">
            <div className="price-box">
                ...
                <h3>300</h3>
                <ul>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> 1000+ Word Post</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> Written By an SEO Specialist</li>
            ...
            <div className="price-box">
                ...
                <h3>150</h3>
                <ul>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> Unlimited Edits</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> Includes Hosting</li>
            ...
            <div className="price-box">
                ...
                <h3>0</h3>
                <ul>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> 2 revisions</li>
                    <li><img aria-hidden="true" src="https://d33wubrfki0l68.cloudfront.net/608a680adbcdbdfc5b0db51ce6104719aaf2b24b/7080e/images/tick.svg" alt=""/> All File Formats</li>
