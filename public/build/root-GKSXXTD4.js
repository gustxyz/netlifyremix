...
var useMedia2 = (queries, values, defaultValue) => {
...
var useMedia_default = useMedia2;
...
function App() {
  ...
  let isMobile = null;
  if (typeof window !== "undefined") {
    isMobile = useMedia(["(min-width: 1250px)", "(max-width: 1249px)"], [false, true], false);
  }
...
//# sourceMappingURL=/build/root-GKSXXTD4.js.map
