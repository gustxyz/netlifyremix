...
var Header = () => {
  ...
  const [navActive, setNavActive] = (0, import_react.useState)(false);
  ...
  return /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("div", {
    ...
    id: "menu-button",
    className: `hamburger hamburger--spring ${navActive ? "is-active" : ""}`,
    ...
    style: navActive ? { width: "60%" } : { width: 0 },
    ...
    id: "on-top",
    className: `navbar-links${activeNave ? "clicked" : ""}`
...
//# sourceMappingURL=/build/root-PDYSYFDD.js.map
